					...
					<form class="divide-y divide-gray-200"  method="POST">
						<div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
							<div class="relative">
								...
								<p class="alert alert-danger"><?php echo $data['email_error'];?></p>
							</div>
							<div class="relative">
								...
								<p class="alert alert-danger"><?php echo $data['password_error'];?></p>
							</div>
							<div class="relative">
								<button name="submit" type="submit" class="bg-blue-500 text-white rounded-md px-2 py-1">Submit</button>
							</div>
						</div>
					</form>
				</div>
