    ...
    <form method="POST" action="<?= URLROOT ?>cruiseController/add_cruise">
        <div class="mt-8 grid lg:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="name" id="name" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" placeholder="Cruise name" required/>
            </div>
            <div>
                <label for="price" class="text-sm text-gray-700 block mb-1 font-medium">Price</label>
                <input type="number" name="price" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" placeholder="$ OR £ OR DH" required/>
            </div>
            <div>
                <label for="picture" class="text-sm text-gray-700 block mb-1 font-medium">picture</label>
                <input type="file" name="picture" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" placeholder="picture" required/>
            </div>
            <div>
                <label for="Date" class="text-sm text-gray-700 block mb-1 font-medium">Date</label>
                <input type="date" name="Date" id="date_reservation" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" placeholder="Date" required/>
            </div>
            <div>
            ...
            <div class="mb-3">
                ...
                <div class="container">
                    <div class="row">
                        <input type="text" name="trajet" id="traget" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full"required="required" >
...
<script>
    var select = document.getElementById("select_traget");
var pos = document.getElementById("traget");
