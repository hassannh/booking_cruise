...
<div class="select_div" style="width: 100% !important;">
    <div class="relative inline-flex">
        ...
        <select class="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
            <option>Start_port</option>
            <option>Red</option>
            <option>Blue</option>FFF
    ...
    <div class="relative inline-flex">
        ...
        <select class="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
            <option>Room_Type</option>
            <option>One_Person</option>
            <option>Two persons</option>
            <option>Two_To_6</option>
    ...
    <div style="padding: 30px; display: flex; flex-wrap: wrap; gap: 10px;">
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white shadow-md rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="rounded-t-lg p-8" src="<?php echo IMAGE; ?>contry.jpg" alt="product image">
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Book Now</a>
                    </div>
                </div>
            </div>
        </div>
